...
export const scrollShadowContent = {
	usage: `<div class="scroll-shadow overflow-y-scroll w-[300px] h-[400px]">
    ${content}
</div>`,
	hideScrollBar: `<div class="scroll-shadow overflow-y-scroll w-[300px] h-[400px]" data-hide-scrollbar>
    ${content}
</div>`,
	customShadowSize: `<div style="--scroll-shadow-size: 100px" class="scroll-shadow overflow-y-scroll w-[300px] h-[400px]">
    ${content}
    </div>`,
	horizontal: `<div class="scroll-shadow overflow-x-scroll max-w-[400px] max-h-[300px] [&>div]:w-[800px]" data-orientation="horizontal">
    ${content}
</div>`,
	offset: `<div class="scroll-shadow overflow-x-scroll max-w-[400px] max-h-[300px] [&>div]:w-[800px]" data-orientation="horizontal" data-offset="100">
    ${content}
</div>`,
};
